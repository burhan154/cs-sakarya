		...
		<div id="sayfa">
			<div id="ust">
				<table border=0 align="center" width=100% height=100% >
					...
					<td width=10% bgcolor=#373c40><a href=# class=top-list>Özgeçmiş</a></td>
			...
			<div id="orta">
				...
				<div id="orta-alan" style="background-color:#ecf0f1;width:800px;margin:20px auto 20px auto;"></div>
			</div>
